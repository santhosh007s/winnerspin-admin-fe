...
// // =======================================================
// // EXTENDED TYPE (Fully safe, no undefined crashes)
// // =======================================================
...
//     const username = w.requester?.username?.toLowerCase() || "";
//     const userid = w.requester?.userid?.toLowerCase() || "";
//     const amount = w.amount?.toString() || "";
...
//   // =======================================================
//   // PROCESSED DATE FIX (Always shows correctly)
//   // =======================================================
//   const getProcessedDate = (w: ExtendedWithdrawal) => {
//     if (w.status === "approved") {
//       if (!w.approvedAt) return "Approved";
//       return new Date(w.approvedAt).toLocaleDateString("en-IN", {
//         dateStyle: "medium",
//       });
//     }
//     if (w.status === "rejected") return "Rejected";
...
//     const id = actionWithdrawal.withdrawal._id;
...
//           <Input
//             placeholder="Search by username, userid or amount..."
//             value={searchTerm}
//             onChange={(e) => setSearchTerm(e.target.value)}
//             className="pl-10"
//           />
